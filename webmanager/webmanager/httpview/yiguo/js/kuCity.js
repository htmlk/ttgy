...
(function($) {
    ...
    KuCity.prototype = {
        ...
        creatItem: function() {
            ...
            var template = '<div class="kucity" style="background: #FFFFFF;border: 2px solid #008842;"><div class="citybox"><h3 class="kucity_header" style="background: #eeeeee">请根据您的收货地址选择</h3><ul class="kucity_nav"><li class="active">热门城市</li><li>ABCDEFGH</li><li>IJKLMNOP</li><li>QRSTUVWXYZ</li></ul><div class="kucity_body"></div></div><ul class="result"></ul></div>';
